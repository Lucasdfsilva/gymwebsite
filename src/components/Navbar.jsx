...
const menuItems = [
  ...
  { id: "trainers", name: "Instrutores" },
  { id: "contact", name: "Contate-nos" },
];
...
const Navbar = () => {
  ...
  return (
    <div>
      <div
        className={`md:fixed ${isSticky ? "bg-black bg-opacity-80" : ""
      ...
      <div
        className={`${menu ? " translate-x-0" : "-translate-x-full"
          } fixed flex flex-col absolute 
          bg-black text-white left-0 top-20 font-semibold 
          text-2xl text-center 
          pt-8 pb-4 gap-8 w-full 
